...
namespace SA.Common.Editor {
	...
	public class Instalation : MonoBehaviour {
		...
		public static void Android_InstallPlugin(bool IsFirstInstall = true) {
			...
			#else
			SA.Common.Util.Files.CopyFile(SA.Common.Config.ANDROID_SOURCE_PATH + "libs/support-v4-23.4.0.txt", 	SA.Common.Config.ANDROID_DESTANATION_PATH + "libs/support-v4-23.4.0.aar");
